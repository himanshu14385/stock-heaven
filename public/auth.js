(function(){
  ...
  const pages={'index.html':'Dashboard','stuck-stock.html':'Stuck Stock','summary.html':'Summary','alert.html':'Alert','fav-stock.html':'Fav Stock','movement-catch.html':'Catch','crypto.html':'Crypto'};
